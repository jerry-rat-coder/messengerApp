...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var body, name, password, email, exisitingUser, hashedPassword, currentUser, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (exisitingUser) {
                        return [2 /*return*/, new server_1.NextResponse('Email already exists', { status: 400 })];
                    }
                ...
                case 4:
                    currentUser = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json(currentUser)];
                case 5:
                    error_1 = _a.sent();
